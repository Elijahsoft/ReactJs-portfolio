      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12">
          ...
          <div className="flex-1 text-center font-secondary lg:text-left ">
            ...
            <motion.p variants={fadeIn('up',0.4)} initial="hidden" whileInView={'show'} viewport={{once:false, amount:0.7}} className="mb-8 max-w-lg mx-auto lg:mx-0">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt
              perferendis ipsa accusamus expedita tempora, quo illo laudantium
              voluptatem dolores consequatur! Temporibus consequuntur
              praesentium officia ducimus nihil rem! Aliquid, at saepe?
            </motion.p>
